...
async def cmd_start(message: Message):
    ...
    text = (
        "Привет 👋\n\n"
        "Этот тест не проверяет грамматику. Он покажет, насколько вы естественно звучите в живом разговоре.\n\n"
        "Здесь нет правильных или неправильных ответов, только разные стили общения.\n\n"
        "В конце вы получите персональный результат и поймете, застряли ли вы в «правильном», но плоском английском.\n\n"
        "Готовы? ⬇️"
    )
