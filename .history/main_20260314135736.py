...
CHANNEL_URL = "https://t.me/yukas_eng"     # <-- замени
...
async def cmd_start(message: Message):
    ...
    # Текст с акцентом на "живой" английский
    text = (
        "Привет! 👋\n\n"
        "Бывает такое: вроде учишь английский годами, знаешь правила, но в разговоре "
        "чувствуешь себя роботом? 🤖\n\n"
        "Этот тест не про скучную грамматику. Он про **Natural English** — тот язык, "
        "на котором реально смеются, спорят и влюбляются в Лондоне или Нью-Йорке.\n\n"
        "Здесь нет «ошибок». Есть только выбор: звучать как учебник или как живой человек.\n\n"
        "В конце ты узнаешь, насколько твой английский близок к оригиналу, и получишь "
        "план, как перестать «переводить в голове» и начать звучать круто. 😎\n\n"
...
# Обработчик нажатия на "Начать тест"
@dp.callback_query(F.data == "start_quiz")
async def process_start_quiz(call: CallbackQuery):
    await call.message.edit_text(
        "Выбирай вариант и погнали! 👇", 
        reply_markup=kb_choose_variant()
    )
    await call.answer()
