...
async def cmd_start(message: Message):
    ...
    text = (
        ...
        "чувствуешь себя <b>роботом</b>? 🤖\n\n"
        "Этот тест не про скучную грамматику. Он про то, как вы звучите в <b>реальной жизни</b> — "
        "там, где люди смеются, спорят и выражают эмоции.\n\n"
        "Здесь нет «ошибок». Есть только выбор: звучать как <b>сухой учебник</b> или как <b>живой человек</b>.\n\n"
        "В конце ты узнаешь свой результат и поймешь, почему речь может звучать <b>«плоско»</b>, "
